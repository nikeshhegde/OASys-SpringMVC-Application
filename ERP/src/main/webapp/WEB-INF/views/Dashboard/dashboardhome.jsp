					...
					<div class="col-md-3">
						<div class="web-stats success">
							<div class="pull-left">
								...
								<c:choose>
								<c:when test="${userModel.getAdmissionUserStatus()=='AppFeePending'}">
								<h5><a href="../applicant/pending">Admission</a></h5>								
								</c:when>
								<c:when test="${userModel.getAdmissionUserStatus()=='AnnualFeePending'}">
								<h5><a href="../applicant/pending">Admission</a></h5>								
								</c:when>
								<c:when test="${userModel.getAdmissionUserStatus()=='Registered'}">
								<h5><a href="trans_id">Admission</a></h5>
								</c:when>
								<c:when test="${userModel.getAdmissionUserStatus()=='AppFeePaid'}">
								<h5><a href="buy_prospectus">Admission</a></h5>
								</c:when>
								<c:when test="${userModel.getAdmissionUserStatus()=='Applied'}">
								<h5><a href="fe7">Admission</a></h5>
								</c:when>
								<c:otherwise>
								<h5><a href="highersemester">Admission</a></h5>
								</c:otherwise>
								</c:choose>
