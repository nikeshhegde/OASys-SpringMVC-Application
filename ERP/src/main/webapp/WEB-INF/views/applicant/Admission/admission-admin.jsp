				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="web-stats warning">
							<div class="pull-left">
								<!-- h5><a href="sub-admission-admin-applicant">Applicant Information</a></h5 -->
								<form action="sub-admission-admin-applicant">
								<input class="button_example" value="Applicant Information" type="submit">
								</form>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!-- h5><a href="sub-admission-admin-merit">Merit List Generation</a></h5-->
								<!--span class="description">Returns</span-->
								<form action="sub-admission-admin-merit">
								<input class="button_example" value="Merit List Generation" type="submit">
								</form>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!-- h5><a href="sub-admission-admin-merit">Merit List Generation</a></h5-->
								<!--span class="description">Returns</span-->
								<form action="/view-merit-list">
								<input class="button_example" value="View Merit List" type="submit">
								</form>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!-- <h5><a href="sub-admission-admin-add-admin">Add a new admin</a></h5>
								span class="description">Returns</span-->
								<form action="sub-admission-admin-add-admin">
								<input class="button_example" value="Add a New Admin" type="submit">
								</form>
							</div>
							<!--span class=" pull-right  mini-graph danger"></span-->
						</div>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!--  h5><a href="schema">View Schema</a></h5>
								<!--span class="description">Returns</span-->
								<form action="schema">
								<input type="submit" class="button_example" value="View Schema">
								</form>
							</div>
							<!--span class=" pull-right  mini-graph danger"></span-->
						</div>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!--  h5><a href="schema">View Schema</a></h5>
								<!--span class="description">Returns</span-->
								<form action="report-menu">
								<input type="submit" class="button_example" value="Report Generation">
								</form>
							</div>
							<!--span class=" pull-right  mini-graph danger"></span-->
						</div>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!--  h5><a href="schema">View Schema</a></h5>
								<!--span class="description">Returns</span-->
								<form action="roll-number-menu">
								<input type="submit" class="button_example" value="Roll Number Generation">
								</form>
							</div>
							<!--span class=" pull-right  mini-graph danger"></span-->
						</div>
