...
<body>
			...
			<tr><td>Amount to be paid</td><td></td></tr>
			<tr><td>Bank name:</td><td> HSBC </td></tr>
			<tr><td>Bank branch:</td><td> Colaba </td></tr>
			<tr><td>City:</td><td> Mumbai </td></tr>
			<tr><td>Account Number:</td><td> 1239419591 </td></tr>
			<tr><td>Account type:</td><td> Savings </td></tr>
			<tr><td>IFSC Number:</td><td>12414-01950</td></tr>
			<tr><td>Account Holder Name</td><td>Anonymous</td></tr>
			
			</table>	
			<form action="higher-semester-step-2" method="get">		
				<div class="form-group">
