...
<body>
<center>
<h1>Welcome to SIES-GST OASys - Online Admission System</h1>
...
<c:choose>
		<c:when test="${userModel.getAdmissionUserStatus()=='Application Fee Pending'}">
		<h5><a href="pending" class="button_example">Proceed</a></h5>								
		</c:when>
		<c:when test="${userModel.getAdmissionUserStatus()=='Annual Fee Pending'}">
		<h5><a href="pending"  class="button_example">Proceed</a></h5>								
		</c:when>
		<c:when test="${userModel.getAdmissionUserStatus()=='Registered'}">
		<h5><a href="../trans_id"  class="button_example">Proceed</a></h5>
		</c:when>
		<c:when test="${userModel.getAdmissionUserStatus()=='Shortlisted'}">
		<h5><a href="../trans_id"  class="button_example">Proceed</a></h5>
		</c:when>
		<c:when test="${userModel.getAdmissionUserStatus()=='Application Fee Paid'}">
		<h5><a href="../buy_prospectus"  class="button_example">Proceed</a></h5>
		</c:when>
		<c:when test="${userModel.getAdmissionUserStatus()=='Applied'}">
		<h5><a href="../fe7"  class="button_example">Proceed</a></h5>
		</c:when>
		<c:otherwise>
		<h5><a href="highersemester">Proceed</a></h5>
		</c:otherwise>
</c:choose>	
</center>
</body>
