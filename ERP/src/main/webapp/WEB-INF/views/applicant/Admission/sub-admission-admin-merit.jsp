...
<head>
	<meta charset="utf-8">
	<title>Admin - Merit List Page</title>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="web-stats warning">
							<div class="pull-left">
								<!-- h5><a href="merit-list?type=fe">First Year</a></h5>
								<!--span class="description">Page Views</span-->
								<form action="generate-merit-list" method="GET">
								<!--input type="hidden" name="type" value="fe"-->
								<input type="submit" value="First Year" class="button_example">
								</form>
							</div>
					...
					<div class="col-md-3">
						<div class="web-stats danger">
							<div class="pull-left">
								<!-- h5><a href="merit-list?type=dse">Direct Second Year</a></h5>
								<!--span class="description">Returns</span-->
								<form action="merit-list" method="GET">
								<input type="hidden" name="type" value="dse">
